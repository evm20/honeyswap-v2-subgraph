# Honeyswap V2 Subgraph

[Honeyswap](https://honeyswap.org/) is a decentralized protocol for automated token exchange on xdai.
...
Contains data across all of Honeyswap V2. This entity tracks important things like total liquidity (in ETH and USD, see below), all time volume, transaction count, number of pairs and more.
